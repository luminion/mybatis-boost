...
public class EnhancedMapperTest {
    ...
    public void testBasicVoQuery() {
        ...
        List<SysUserVO> result = sysUserMapper.voQueryByXml(sqlEntity, null);
    ...
    public void testVoQueryWithPagination() {
        ...
        List<SysUserVO> result = sysUserMapper.voQueryByXml(sqlEntity, page);
        
        assertNotNull(result);
        assertTrue(result.size() <= 2);
        assertEquals(1, page.getCurrent());
        assertEquals(2, page.getSize());
        assertTrue(page.getTotal() >= 3); // 至少有3个用户年龄>=25
    }
    ...
    public void testMultipleConditions() {
        ...
        assertNotNull(result);
        assertEquals(3, result.size()); // 张三、李四、王五
        result.forEach(user -> {
    ...
    public void testLikeQuery() {
        ...
        assertNotNull(result);
        assertEquals(4, result.size()); // 所有用户的description都包含"测试"
    ...
    public void testInQuery() {
        ...
        assertNotNull(result);
        assertEquals(2, result.size()); // 张三和李四
    ...
    public void testSorting() {
        ...
        assertNotNull(result);
        assertEquals(3, result.size()); // 有名字的用户
    ...
    public void testEmptyConditions() {
        ...
        assertNotNull(result);
        assertEquals(4, result.size()); // 应该返回所有用户
    }
    ...
    public void testNullValueQuery() {
        ...
        assertNotNull(result);
        assertEquals(1, result.size()); // user4的name为null
    ...
    public void testNotNullQuery() {
        ...
        assertNotNull(result);
        assertEquals(3, result.size()); // 除了user4，其他用户的name都不为null
    ...
    public void testNotInQuery() {
        ...
        assertNotNull(result);
        assertEquals(2, result.size()); // 王五和user4
        result.forEach(user -> assertFalse(Arrays.asList(25, 30).contains(user.getAge())));
    }
    ...
    public void testNotLikeQuery() {
        ...
        assertNotNull(result);
        assertEquals(2, result.size()); // 李四和王五
        result.forEach(user -> {
            assertNotNull(user.getName());
    ...
    public void testBoundaryConditions() {
        // 测试空的SqlEntity
        assertDoesNotThrow(() -> {
            List<SysUserVO> result = sysUserMapper.voQueryByXml(new SqlEntity(), null);
            assertNotNull(result);
        });
