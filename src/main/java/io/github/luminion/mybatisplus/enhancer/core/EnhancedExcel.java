...
//import io.github.luminion.mybatisplus.enhancer.util.ExcelUtil;
...
//        DynamicMapper dynamicMapper = CastUtil.cast(this, DynamicMapper.class);
//        List<?> voList = dynamicMapper.voPage(param, current, size).getRecords();
